        ...
        return <View style={styles.container}>
            ...
            <View style={styles.body}>
                ...
                <View style={[styles.dashed, styles.clockView]}>
                    <View style={[{borderBottomWidth: 1, borderColor: '#ffc4d6'}, styles.flexRow]}>
                        ...
                        <TouchableOpacity activeOpacity={0.7} onPress={() => {
                            navPush.push(this.props, CheckedDetail, '分娩时间', {text: '分娩时间'})
                        }}>
                    ...
                    <View style={{}}>
                        <TouchableOpacity activeOpacity={0.7} onPress={() => {
                            navPush.push(this.props, CheckedDetail, '产检重点', {text: '产检重点'})
                        }}>
                ...
                <View style={[styles.dashed, styles.tipsView]}>
                    <View style={[{borderBottomWidth: 1, borderColor: '#c4f1ff'}, styles.flexRow]}>
                        ...
                        <TouchableOpacity activeOpacity={0.7} onPress={() => {
                            ...
                            <Text style={styles.text} numberOfLines={1}>最好于11-21前计划女好<Text style={{color: '#00b8cc'}}>分娩医院</Text></Text>
                        </TouchableOpacity>
                    </View>
                ...
                <View style={{flexDirection: 'row'}}>
                    ...
                    <TouchableOpacity style={[styles.dashed, styles.tipsTool, {marginLeft: 14, marginRight: 14}]} activeOpacity={0.6} onPress={() => {
                    ...
                    <TouchableOpacity style={[styles.dashed, styles.tipsTool]} activeOpacity={0.6} onPress={() => {
                        ...
                        <View style={styles.tipsToolView}>
                            <Image source={require('../img/yongcantixing.png')} style={[styles.tipsToolImg, {width: 20}]} resizeMode='stretch'/>
